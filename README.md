...
- The durable authority catalog contains 188 variants: 187 production-covered rows, including all 48 generic amendment rows, plus the sole future-only `final-plan-descriptor` row.
