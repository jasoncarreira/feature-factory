...
| Schema-v2 full-plan continuation | `continuation-envelope`; `continuation-parent-binding`; `continuation-selected-review`; `continuation-target-binding`; current plan/review/accepted-slice sidecars; closed configuration and full-plan carry-forward partition | Parent/child identity, exact current plan hash, immutable accepted rows, and disjoint nonempty remaining slice IDs |
