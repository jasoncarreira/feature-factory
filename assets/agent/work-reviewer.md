...
4. **Apply the subject checks.**
   ...
   - For decomposition, REJECT orphan acceptance criteria, cyclic dependencies, same-wave path overlap, un-serialized hotspots, or a dependency path deeper than three waves (root is wave 1).
