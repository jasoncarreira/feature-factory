...
- New slice review sidecars carry boolean `late_discovery_strike`. A consequential attempt-1-discoverable category first raised on attempt 2 records the one permitted strike, remains converging, and consumes normal attempt 3. New nonconvergent review publication before final attempt 3 rejects unless exact prior history contains the strike; rejected final attempt 3 uses the existing terminal carry-forward route. Older sidecars may omit the marker and remain read-compatible.
