...
Commands:
  ...
  factory repair <run-id> <reported|repairing|review|merged|blocked> [--owner-slice ID --consumer-slice ID --defect-path PATH --evidence-ref REF] [--attempts N] [--review-ref REF --evidence-ref REF] [--merge-commit SHA --verification-ref REF] [--reason TEXT]
