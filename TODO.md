...
- PR #50 (the `output-policy` handoff from `centralized-hardening-primitives-continuation-2`) merged as `fad78fb` after Mimir approval and a green full repository check.
